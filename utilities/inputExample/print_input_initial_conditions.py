...
with open('input_initial_conditions.txt', 'w') as file:
    ...
    file.write('0.0\n')
    file.write('#   initial Am241 (% of heavy atoms) content\n')
    file.write('0.0\n')
    file.write('#   initial Am242 (% of heavy atoms) content\n')
    file.write('0.0\n')
    file.write('#   initial Cm242 (% of heavy atoms) content\n')
    file.write('0.0\n')
    file.write('#   initial Pu (% of heavy atoms) content')