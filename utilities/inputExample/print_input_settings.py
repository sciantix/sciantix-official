...
with open('input_settings.txt', 'w') as file:
    ...
    file.write('0\t#\tiGrainBoundaryHeliumBehaviour (0= not considered)\n')
    file.write('0\t#\tiGrainBoundaryHeliumDiffusivity (...)\n')
    file.write('0\t#\tiGrainBoundaryHeliumTrappingRate (...)\n')
    file.write('0\t#\tiGrainBoundaryHeliumThermalResolution (...)')
