...
# UO2 irradiation histories and the dislocation-partition figures.  No options;
# everything is set in the RUN CONFIGURATION block at the end of the file.
python3 phasefield_tandogan_1d.py            # long: the whole set at 1000 cells
