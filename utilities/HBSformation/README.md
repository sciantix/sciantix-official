...
| 4 Landau functional | 0.1461 | +0.433 | never seen them (out-of-sample) |
...
|---|---|---|---|
| 64.32 | 0.2687 | 0.4270 | **+0.1583** |
| 70.91 | 0.5438 | 0.5515 | +0.0077 |
| 72.27 | 0.5534 | 0.5747 | +0.0213 |
| 77.05 | 0.5979 | 0.6630 | +0.0651 |
| 83.86 | 0.6211 | 0.8087 | **+0.1876** |
| 88.41 | 0.6869 | 0.9210 | **+0.2341** |
| 90.68 | 0.7566 | 0.9821 | **+0.2255** |
| 129.77 | 1.0002 | 1.0000 | −0.0002 |

Four of the eight now carry a residual above +0.10 — the three at 84–91 MWd/kgU where the
lever rule saturates while the data is still at 0.62–0.76, and the first point at 64.3,
which the earlier onset brought inside the transition. All four are on the same side.
...
| 4 Landau functional — at bu_local | **0.2122** | **+0.710** |
