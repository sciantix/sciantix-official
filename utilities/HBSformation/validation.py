...
Two independent datasets
  ...
  PIE, Gerczak (2018) / Noirot (2015) -- 8 rim positions, restructured fraction
      ...
      3 were calibrated on. This work (option 4) has never seen it.
  ...
  EBSD, Zacharie-Aubrun et al. (2022) / Onofri et al. (2025) -- 41 radial points
      ...
      produce: the mean misorientation and the subgrain radius.
...
# Copied from `context/kjma_fit_comparison.py` (G. Zullo),
# Burnup in MWd/kgU; the rim temperature is not resolved per point and is 
# taken as 900 K for all of them.
# ---------------------------------------------------------------------------
...
# How each option relates to the 8 PIE points
#
