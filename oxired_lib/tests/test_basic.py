...
from oxired import CylinderGeometry, OxiRedCylinder, OxygenBalanceModel, PolynomialProfile
...
def test_oxygen_balance_quantities_scale_with_burnup() -> None:
    ...
    result = balance.target_average_om(initial_average_om=1.975, burnup_at_percent=1.0)
