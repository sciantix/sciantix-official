...
def main() -> None:
    ...
    result = balance.target_average_om(
        ...
        burnup_at_percent=burnup_final,
    ...
    burnup_values = np.linspace(0.0, burnup_final, 40)
    ...
    plt.grid(True)
    plt.savefig(histories_dir / "Tprofile.png")
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(histories_dir / "OMprofile.png")
