...
)
{
    std::vector<SciantixVariable> init_sciantix_variable =
    {
        ...
        SciantixVariable("CsI produced", "(at/m3)", Sciantix_variables[121], Sciantix_variables[121], 1),
        SciantixVariable("CsI in grain", "(at/m3)", Sciantix_variables[122], Sciantix_variables[122], 1),
        SciantixVariable("CsI in intragranular solution", "(at/m3)", Sciantix_variables[123], Sciantix_variables[123], 1),
        SciantixVariable("CsI in intragranular bubbles", "(at/m3)", Sciantix_variables[124], Sciantix_variables[124], 1),
