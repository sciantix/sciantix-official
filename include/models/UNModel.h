...
namespace un_model
{
    ...
    constexpr double rho_width = 120.0;  // Rizk nominal temperature width = not specified; used/calibrated = 120 K.
    constexpr double rho_f_min =
        0.08;  // Rizk nominal high-temperature floor factor = not specified; used/calibrated = 0.08.
                                              ...
                                              const double constant_rho)
    {
        ...
        const double ft  = rho_f_min + (1.0 - rho_f_min) / (1.0 + std::exp((temperature - rho_t_half) / rho_width));
