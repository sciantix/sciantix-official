#!/usr/bin/env python3
"""
UN_M7_optuna_calibration_v13_rhoSat_partition_STANDALONE.py

V13 diagnostic wrapper:
...
def main():
    parser = argparse.ArgumentParser(description="V13: rhoFT2 + gas-to-grain-face constrained + high-T dislocation gas plateau + Rizk Fig.8 radius anchors.")
    ...
    global W_RIZK_FIG8_DISL_RADIUS, W_RIZK_FIG8_BULK_RADIUS, W_RIZK_FIG6_DISL_BURNUP, W_V13_PARTITION, W_V13_QGB, W_ND_HIGHT_LOW_TARGET
    ...
    print("#" * 120)
    print("V13 rhoSat + gas-to-grain-face + high-T dislocation plateau settings")
