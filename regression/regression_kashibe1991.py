...
def do_plot():
  ...
  ax.scatter(np.concatenate([FGRAnnealing[0:2],FGRAnnealing[4:9]]),np.concatenate([FGR2Annealing[0:2],FGR2Annealing[4:9]]),c='#9370DB', marker = '^', s=40,         label='This work - 23 GWd tU$^{-1}$')
  ax.scatter(np.concatenate([FGRAnnealing[2:4],FGRAnnealing[9:13]]),np.concatenate([FGR2Annealing[2:4],FGR2Annealing[9:13]]), facecolors = 'none', edgecolors = '#9370DB', marker = '^', s=40,    label='This work - 28 GWd tU$^{-1}$')
  ax.scatter(np.concatenate([FGRAnnealing[0:2],FGRAnnealing[4:9]]),np.concatenate([AnnFGRVersion2[0:2],AnnFGRVersion2[4:9]]), c='#66CDAA', marker = 'd', s=40, label='SCIANTIX 2.0 - 23 GWd tU$^{-1}$', alpha =0.7)
  ax.scatter(np.concatenate([FGRAnnealing[2:4],FGRAnnealing[9:13]]),np.concatenate([AnnFGRVersion2[2:4],AnnFGRVersion2[9:13]]), facecolors = 'none', edgecolors='#66CDAA', marker = 'd', s=40, label='SCIANTIX 2.0 - 28 GWd tU$^{-1}$', alpha =0.7)
