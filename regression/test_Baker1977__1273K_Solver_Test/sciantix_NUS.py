...
and plot the quantities in the source_shape.txt file
the purpose is to plot the source input from the non_uniform_source.txt file
...
class SourcePlotterGUI:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Sciantix Source Radial Profile Plotter")
        self.canvas = None
        self.filename = None
        self.header = None
        self.data = None
        ...
        # Auto-load default source file if present
        default_file = "source_shape.txt"
    ...
    def plot_selected(self):
        ...
        ax.set_title("Source Radial Profile S(r)")
        ax.set_xlabel("r (micron)")
        ax.set_ylabel("S (at/m³·s)")
