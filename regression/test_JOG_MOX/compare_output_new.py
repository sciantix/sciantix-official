...
def main() -> int:
    ...
    parser.add_argument("old", nargs="?", default="point_02_r_0p2025mm/output.txt", type=Path)
    parser.add_argument("new", nargs="?", default="point_02_r_0p2025mm/output_2.txt", type=Path)
