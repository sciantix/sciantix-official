...
def main() -> int:
    ...
    parser.add_argument("old", nargs="?", default="800K/thermochemistry_output.txt", type=Path)
    parser.add_argument("new", nargs="?", default="800K/thermochemistry_output_2.txt", type=Path)
