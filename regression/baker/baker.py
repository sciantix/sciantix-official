import os
from regression.core.common import run_sciantix, make_gold, compare_outputs
from regression.core.parser import SciantixOutput

def run_baker(case_dir: str, mode_gold: int):
    """
    Run a single Baker case.
    mode_gold:
      0 = run + compare
      1 = run + gold
      2 = compare only
    ...
    if mode_gold in (0, 1):
        ...
        out_gold = SciantixOutput(gold_path) if os.path.exists(gold_path) else None
