...
void Simulation::GrainGrowth()
{
    ...
    switch (int(input_variable["iGrainGrowth"].getValue()))
    {
        ...
        /** @brief iGrainGrowth = 1 considers that the grain growth kinetic is described by the
         * semi-empirical model from <a
         * href="https://www.sciencedirect.com/science/article/abs/pii/0022311573900019"
         * target="_blank">Ainscough J.B. et al (1973). Journal of Nuclear Materials, 49,
         * 117-128.</a> This model includes two contributions on the grain growth:
         * 1. Temperature;
         ...
         * @ref <a href="https://www.sciencedirect.com/science/article/abs/pii/S0022311512006526"
         * target="_blank">Van Uffelen P. et al (2013). Journal of Nuclear Materials, 434,
         * 287-290.</a> by means of the following equations: 1) dD/dt = k/4D^3   if D < Dm 2) dD/dt
         * = 0        if D > Dm where D = grain diameter (um) k, the rate constant, is k
         * =  3.1347e+14 * exp(-46524 / T)  (um^4/h) T = temperature (K) Dm = limiting grain
         * diameter
         */
        case 2:
        {
