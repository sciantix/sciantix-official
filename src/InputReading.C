...
void InputReading()
{
	...
	if (!input_scaling_factors.fail())
	{
		...
		Sciantix_scaling_factors[8] = ReadOneParameter("sf_span_parameter", input_scaling_factors, input_check);
		Sciantix_scaling_factors[9] = ReadOneParameter("sf_geometrical_parameter", input_scaling_factors, input_check);
		Sciantix_scaling_factors[10] = ReadOneParameter("sf_dummy", input_scaling_factors, input_check);
	}
	else
	{
