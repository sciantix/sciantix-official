 ...
 */
std::vector<double> ReadSeveralParameters(std::string variable_name, std::ifstream& input_file,
                                          std::ofstream& output_file)
{
    char      comment;
    double    variable;
                  ...
                  std::vector<double>& Steampressure_input, double& Time_end_h, double& Time_end_s)
{
    ...
    {
        Sciantix_variables[0] =
            ReadOneParameter("Grain radius[0]", input_initial_conditions, input_check);

        std::vector<double> initial_composition_Xe;
        initial_composition_Xe =
            ReadSeveralParameters("Initial composition Xe", input_initial_conditions, input_check);
        ...
        initial_composition_Kr =
            ReadSeveralParameters("Initial composition Kr", input_initial_conditions, input_check);
        ...
        initial_composition_He =
            ReadSeveralParameters("Initial composition He", input_initial_conditions, input_check);
        ...
        initial_intragranular_bubbles = ReadSeveralParameters(
            "Initial intragranular bubbles", input_initial_conditions, input_check);
        Sciantix_variables[19] = initial_intragranular_bubbles[0];
        Sciantix_variables[20] = initial_intragranular_bubbles[1];

        Sciantix_variables[38] =
            ReadOneParameter("Burn_up[0]", input_initial_conditions, input_check);
        Sciantix_variables[39] =
            ReadOneParameter("Effective_burn_up[0]", input_initial_conditions, input_check);
        Sciantix_variables[65] =
            ReadOneParameter("Irradiation_time[0]", input_initial_conditions, input_check);
        Sciantix_variables[40] =
            ReadOneParameter("Fuel_density[0]", input_initial_conditions, input_check);

        std::vector<double> initial_composition_U;
        initial_composition_U =
            ReadSeveralParameters("Initial composition U", input_initial_conditions, input_check);
        ...
        initial_composition_Xe133 = ReadSeveralParameters("Initial composition Xe133",
                                                          input_initial_conditions, input_check);
        ...
        initial_composition_Kr85m = ReadSeveralParameters("Initial composition Kr85m",
                                                          input_initial_conditions, input_check);
        ...
        Sciantix_variables[66] = ReadOneParameter("Initial stoichiometry deviation[0]",
                                                  input_initial_conditions, input_check);

        Sciantix_variables[150] =
            ReadOneParameter("Chromium content", input_initial_conditions, input_check);
    }
