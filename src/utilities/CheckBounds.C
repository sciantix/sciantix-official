...
void checkBounds(){
    ...
    sciantix_variable[sv["Xe in grain"]].isWithinBoundsValidation(sciantix_variable[sv["Xe in grain"]].getFinalValue());
    ...
    sciantix_variable[sv["Xe released"]].isWithinBoundsValidation(sciantix_variable[sv["Xe released"]].getFinalValue());
    sciantix_variable[sv["Kr produced"]].isWithinBounds(sciantix_variable[sv["Kr produced"]].getFinalValue());
    sciantix_variable[sv["Kr in grain"]].isWithinBoundsValidation(sciantix_variable[sv["Kr in grain"]].getFinalValue());
    ...
    sciantix_variable[sv["Kr released"]].isWithinBoundsValidation(sciantix_variable[sv["Kr released"]].getFinalValue());
    sciantix_variable[sv["He produced"]].isWithinBounds(sciantix_variable[sv["He produced"]].getFinalValue());
    sciantix_variable[sv["He in grain"]].isWithinBoundsValidation(sciantix_variable[sv["He in grain"]].getFinalValue());
    ...
    sciantix_variable[sv["He released"]].isWithinBoundsValidation(sciantix_variable[sv["He released"]].getFinalValue());
    sciantix_variable[sv["Intragranular bubble concentration"]].isWithinBoundsValidation(sciantix_variable[sv["Intragranular bubble concentration"]].getFinalValue());
    sciantix_variable[sv["Intragranular bubble radius"]].isWithinBoundsValidation(sciantix_variable[sv["Intragranular bubble radius"]].getFinalValue());
    ...
    sciantix_variable[sv["Intragranular gas bubble swelling"]].isWithinBoundsValidation(sciantix_variable[sv["Intragranular gas bubble swelling"]].getFinalValue());
    ...
    sciantix_variable[sv["Intergranular bubble concentration"]].isWithinBoundsValidation(sciantix_variable[sv["Intergranular bubble concentration"]].getFinalValue());
    ...
    sciantix_variable[sv["Intergranular bubble area"]].isWithinBoundsValidation(sciantix_variable[sv["Intergranular bubble area"]].getFinalValue());
    ...
    sciantix_variable[sv["Intergranular fractional coverage"]].isWithinBoundsValidation(sciantix_variable[sv["Intergranular fractional coverage"]].getFinalValue());
    ...
    sciantix_variable[sv["Intergranular gas swelling"]].isWithinBoundsValidation(sciantix_variable[sv["Intergranular gas swelling"]].getFinalValue());
    ...
    sciantix_variable[sv["Xe133 in grain"]].isWithinBoundsValidation(sciantix_variable[sv["Xe133 in grain"]].getFinalValue());
    ...
    sciantix_variable[sv["Xe133 released"]].isWithinBoundsValidation(sciantix_variable[sv["Xe133 released"]].getFinalValue());
    ...
    sciantix_variable[sv["Kr85m in grain"]].isWithinBoundsValidation(sciantix_variable[sv["Kr85m in grain"]].getFinalValue());
    ...
    sciantix_variable[sv["Kr85m released"]].isWithinBoundsValidation(sciantix_variable[sv["Kr85m released"]].getFinalValue());
