...
{   
    ...
    {
        std::ifstream input_fileU1("GPregression/Results/UpdatedCorrelation_XeDiffusionCoefficient.txt");
        std::ifstream input_fileS1("GPregression/Results/StandardDeviation_XeDiffusionCoefficient.txt");
