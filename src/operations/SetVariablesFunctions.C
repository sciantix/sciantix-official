                                                         ...
                                                         bool   toOutputMOX)
{
    std::vector<SciantixVariable> init_sciantix_variable = {
        ...
        SciantixVariable("JOG from CS2MOO4_S1", "(/)", 0.0, 0.0, toOutputThermochimica),
        SciantixVariable("JOG from CS2MOO4_S2", "(/)", 0.0, 0.0, toOutputThermochimica),
