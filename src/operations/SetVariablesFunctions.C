...

{
    std::vector<SciantixVariable> init_sciantix_variable = {
        ...
        SciantixVariable(
            "Cm precipitated intragranular", "(at/m3)", Sciantix_variables[173], Sciantix_variables[173], toOutputCm),
        SciantixVariable(
            "Cm precipitated grain boundary", "(at/m3)", Sciantix_variables[174], Sciantix_variables[174], toOutputCm),
        SciantixVariable(
...
std::vector<std::string> getScalingFactorsNames()
{
    std::vector<std::string> names = {
        ...
        "Dummy",
        // EC 04.06.2026: scaling factor per calibrazione più flessibile del modello di precipitazione dei prodotti di
        // fissione metallici (MFP)
        "MFP nucleation rate",
        "MFP precipitation rate intragranular",
        "MFP precipitation rate grain boundary",
        "MFP resolution rate",
        "MFP nucleation energy barrier",
        "MFP intra activation energy",
        "MFP grain boundary activation energy",
        "MFP nucleation energy barrier grain boundary",
        "MFP nucleation rate grain boundary",
    };
