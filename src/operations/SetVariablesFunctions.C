                                                         ...
                                                         bool   toOutputMOX)
{
    std::vector<SciantixVariable> init_sciantix_variable = {
        ...
        SciantixVariable("Cs reacted - GB", "(at/m3)", Sciantix_variables[107], Sciantix_variables[107],  toOutputThermochimica),
        ...
        SciantixVariable("I reacted - GB", "(at/m3)", Sciantix_variables[117], Sciantix_variables[117],  toOutputThermochimica),
        ...
        SciantixVariable("Te reacted - GB", "(at/m3)", Sciantix_variables[127], Sciantix_variables[127],  toOutputThermochimica),
        ...
        // CODE DEVELOPMENT : MO VARIABLE - TO BE REDUCED
        SciantixVariable("Mo produced", "(at/m3)", Sciantix_variables[131], Sciantix_variables[131],  toOutputThermochimica),
        SciantixVariable("Mo in grain", "(at/m3)", Sciantix_variables[132], Sciantix_variables[132],  toOutputThermochimica),
        SciantixVariable("Mo in intragranular solution", "(at/m3)", Sciantix_variables[133], Sciantix_variables[133],  toOutputThermochimica),
        SciantixVariable("Mo in intragranular bubbles", "(at/m3)", Sciantix_variables[134], Sciantix_variables[134],  toOutputThermochimica),
        SciantixVariable("Mo at grain boundary", "(at/m3)", Sciantix_variables[135], Sciantix_variables[135],  toOutputThermochimica),
        SciantixVariable("Mo released", "(at/m3)", Sciantix_variables[136], Sciantix_variables[136],  toOutputThermochimica),
        SciantixVariable("Mo decayed", "(at/m3)", 0.0, 0.0, 0),
        SciantixVariable("Mo reacted - GB", "(at/m3)", Sciantix_variables[137], Sciantix_variables[137],  toOutputThermochimica),
