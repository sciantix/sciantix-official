    ...
    switch (input_value)
    {
        ...
        case 1:
        {
            ...
            grain_boundary_mobility =
                1.455e-8 * exp(-32114.5 / history_variable["Temperature"].getFinalValue());
            break;
        }
        ...
        case 2:
        {
            ...
            grain_boundary_mobility =
                1.360546875e-15 * exp(-46524.0 / history_variable["Temperature"].getFinalValue());
            break;
        }
    ...
    switch (input_value)
    {
        ...
        case 1:
        {
            grain_boundary_diffusivity =
                6.9e-04 * exp(-5.35e-19 / (boltzmann_constant *
        ...
        case 2:
        {
            ...
            reference +=
                "iGrainBoundaryVacancyDiffusivity: from White, JNM, 325 (2004), 61-77.\n\t";
        ...
        {
            grain_boundary_diffusivity =
                (1.3e-7 * exp(-4.52e-19 / (boltzmann_constant *
                                           history_variable["Temperature"].getFinalValue())));
