...
void He_in_MOX()
{
	...
	sciantix_system[index].setName("He in MOX");
	...
	sciantix_system[index].setVolumeInLattice(matrix[sma["MOX"]].getOIS());
	...
	sciantix_system[index].setANN(input_variable[iv["iANNHelium"]].getValue());
}
