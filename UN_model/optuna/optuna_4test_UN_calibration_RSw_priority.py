...
def parse_args(argv=None):
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("optuna_4test_UN_results_RSw_priority"))
    parser.add_argument("--study-name", type=str, default="optuna_4test_UN_RSw_priority")
