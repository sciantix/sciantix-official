...
# ========================================= #
#      Backward Solver Full Order Class     #
# ========================================= #
...
# ============================================ #
#      Backward Solver Reduced Basis Class     #
# ============================================ #
...
class ReducedBasisCylinderSolver(object):
    ...
    def __init__(self, basis):
        ...
        self.XX_rietz = linalg.spsolve(self.YY_FO, self.XX_right).reshape(basis.shape)
        ...
        self.KK_rietz = np.array([linalg.spsolve(self.YY_FO, self.KK_right[ii]).reshape(basis.shape) for ii in range(self.sHR)])
