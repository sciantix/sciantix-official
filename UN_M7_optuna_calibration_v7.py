#!/usr/bin/env python3
"""
UN_M7_optuna_calibration_v7.py
...
Purpose of v7:
  ...
  - keep v6 physics split and add stronger Nd/coalescence, bulk plateau, and high-T pressure scoring so R_d(T) cannot keep accelerating after ~1800 K.

Recommended first use:
  python UN_M7_optuna_calibration_v7.py --family capture_only --dv-min 0.2 --dv-max 2.0 \
...
import UN_M7_optuna_calibration_v7_core as m
...
def main():
    ...
    global W_ND_DROP_TARGET, W_BULK_PLATEAU, W_HIGHT_PRESSURE
