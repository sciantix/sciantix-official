...
class Candidate:
    ...
    # v6 global: Xe D2 can be scaled explicitly; it is usually small but kept as exploration lever.
...
def xe_diffusivity_UN(p: UNParameters):
    ...
    # v6 global option: include Xe D2 with its own scale.
    # Rizk reports D2_Xe as usually small, but we keep it as an explicit diagnostic/exploration lever.
    ...
    return Dg, {
        ...
        "D2_Xe_over_Dg_unscaled": (D2_scaled / Dg_unscaled) if Dg_unscaled > 0 and math.isfinite(Dg_unscaled) else math.nan,
        "Dg": Dg,
    }
